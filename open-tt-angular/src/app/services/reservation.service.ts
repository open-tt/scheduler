...
export class ReservationService {
  ...
  loadReservationsForUser(apiToken: string, userId: number): Observable<Reservation[]>{
    ...
    return this.http.get<ReservationApi.ReservationResponse>(url, httpOptions).pipe(
      map(
        reservationResponse => {
